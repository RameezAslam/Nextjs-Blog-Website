...
export function BlogpostCard({ data }: IappProps) {
    return (
        ...
        border-gray-200 bg-white shadow-md hover:shadow-lg transition-all">
            ...
            <div className="p-4">
                <h3 className="text-lg mb-2 font-semibold text-gray-900">{data.title}</h3>
                <p className="text-sm text-gray-600 mb-4 line-clamp-3">{data.content}</p>
